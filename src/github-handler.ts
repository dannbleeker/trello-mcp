...
app.get("/authorize", async (c) => {
	...
	return renderApprovalDialog(c.req.raw, {
		...
		csrfToken,
		server: {
			description: "Personal Trello connector. Sign in with GitHub to grant Claude access to your Trello boards via this MCP server.",
			logo: "https://avatars.githubusercontent.com/u/4825104?s=200&v=4",
			name: "Trello MCP (Dann)",
		},
		setCookie,
		state: { oauthReqInfo },
	});
